...
CREATE TABLE `products` (
    ...
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` DATETIME(3) NOT NULL,
    `offer2_original_price` DOUBLE NULL,
    `offer2_sale_price` DOUBLE NULL,
    `offer3_original_price` DOUBLE NULL,
    `offer3_sale_price` DOUBLE NULL,
...
CREATE TABLE `Order` (
    ...
    `status` ENUM('PENDING', 'LIVREE', 'RETOUR', 'ANNULEE') NOT NULL DEFAULT 'PENDING',
